...
- Make changes in the current project and the template project. Do not look into downstream projects; anything meant to propagate reaches them through sync eventually.
